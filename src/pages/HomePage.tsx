      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-screen items-center px-6 pt-16 pb-28 sm:px-10 sm:pb-32 lg:px-16 lg:pb-40">
          <div className="max-w-3xl">
            <p className="mb-4 text-sm font-medium uppercase tracking-[0.28em] text-cyan-200/80">WebSong</p>
            <h1 className="max-w-2xl text-5xl leading-none font-semibold text-white sm:text-7xl">
              Sound made visible.
            </h1>
